...
import com.poll.web.payload.response.ChoiceResponse;
import com.poll.web.payload.response.PollResponse;
import com.poll.web.payload.response.UserSummary;
...
public class ModelMapper {
    public static PollResponse mapPollToPollResponse(Poll poll, Map<Long, Long> choiceVotesMap, User creator, Long userVote) {
        ...
        pollResponse.setIsExpired(poll.getExpirationDateAndTime().isBefore(now));
